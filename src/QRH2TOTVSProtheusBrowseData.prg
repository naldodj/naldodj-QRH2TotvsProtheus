...
procedure QRH2TOTVSProtheusBrowseData(oRecordSet,cTitle,lExcel)
    ...
    @  if(lExcel,35,10),  10 TBROWSE oQRH2TotvsBrowseData RECORDSET oRecordSet  EDITABLE AUTOCOLS SELECTOR .T. ;
